    ...
    for frame_idx, (path, img, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                dt[3] += t5 - t4
                # area
                area1 = [(210,438),(720,438),(925,718),(150,718)]
                area2 = [(100,200),(310,185),(230,430),(100,350)]
                area3 = [(340,80),(450,80),(500,180),(300,180)]
                area4 = [(760,200),(1150,230),(1245,310),(1080,380)]
                ...
                if len(outputs) > 0:
                    ...
                    for j, (output, conf) in enumerate(zip(outputs, confs)):
                        ...
                        schedule = Scheduler()
                        schedule.minutely(dtime.time(second=15), reset)
            ...
            if show_vid:
                ...
                cv2.putText(im0, str(truk_kanan) + '  Truk Kanan', (1050,140), font, 
                    fontScale, color_font, thickness, cv2.LINE_AA)
                cv2.putText(im0, str(motor_lurus) + '  Motor Lurus', (500,50), font, 
                    fontScale, color_font, thickness, cv2.LINE_AA)
                cv2.putText(im0, str(mobil_lurus) + '  Mobil Lurus', (500,80), font, 
                    fontScale, color_font, thickness, cv2.LINE_AA)
                cv2.putText(im0, str(bus_lurus) + '  Bus Lurus', (500,110), font, 
                    fontScale, color_font, thickness, cv2.LINE_AA)
                cv2.putText(im0, str(truk_lurus) + '  Truk Lurus', (500,140), font, 
                    fontScale, color_font, thickness, cv2.LINE_AA)
                cv2.putText(im0, str(timenow) , (50,650), font, 
                    fontScale, color_font, thickness, cv2.LINE_AA)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='videos/MVI_0173.MOV', help='source')  # file/folder, 0 for webcam
